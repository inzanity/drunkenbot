...
CBuilding(aObjPtr, new CBuildingData(CAnimationStorage::ptr()->getAnimation("data/dock.x"), NULL, CAnimationStorage::ptr()->getAnimation("data/dock.x"), 1, "Foobar", NULL, 0, 1, 1, 1, 1, 1, 1, DOCKYARD, 1, NULL, 0), aReady, aPos, aXAngle, aYAngle)
{
